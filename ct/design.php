			...
			<div id="content">
				...
				<div id="list" style="margin-left: 25px;">
					...
					<ul>
					    ...
					    <li>Our Design and Build skills include <span style="color: #00B0F0; font-weight: bold;">Sat/Nav, GIS, SMS, 3G/GPRS, and Internet Messaging</span>. We can apply any or all of these techniques in building the system you require.</li>
